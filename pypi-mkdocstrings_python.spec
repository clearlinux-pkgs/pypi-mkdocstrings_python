...
Version  : 1.7.0
Release  : 16
URL      : https://files.pythonhosted.org/packages/0e/36/7dba2bb3211420952ac9bf2a95a383f34d56a0d42a132a1aa622597c7ba8/mkdocstrings_python-1.7.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/0e/36/7dba2bb3211420952ac9bf2a95a383f34d56a0d42a132a1aa622597c7ba8/mkdocstrings_python-1.7.0.tar.gz
...
%prep
%setup -q -n mkdocstrings_python-1.7.0
cd %{_builddir}/mkdocstrings_python-1.7.0
pushd ..
cp -a mkdocstrings_python-1.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694706969
