...
Version  : 0.8.3
Release  : 1
URL      : https://files.pythonhosted.org/packages/2c/30/47c1db07d5a6ecbf9a8ea251e1cfb91ec5f8bc4ab1ead417dcc1932ab616/mkdocstrings-python-0.8.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/2c/30/47c1db07d5a6ecbf9a8ea251e1cfb91ec5f8bc4ab1ead417dcc1932ab616/mkdocstrings-python-0.8.3.tar.gz
...
%prep
%setup -q -n mkdocstrings-python-0.8.3
cd %{_builddir}/mkdocstrings-python-0.8.3
pushd ..
cp -a mkdocstrings-python-0.8.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675189195
