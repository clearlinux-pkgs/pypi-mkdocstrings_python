...
Source0  : https://files.pythonhosted.org/packages/b1/48/f085a737da288ff09a2444e8826b2ec76d76a9e890527162aa0e0bf7ffbd/mkdocstrings_python-1.9.2.tar.gz
...
%prep
%setup -q -n mkdocstrings_python-1.9.2
cd %{_builddir}/mkdocstrings_python-1.9.2
pushd ..
cp -a mkdocstrings_python-1.9.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712110234
