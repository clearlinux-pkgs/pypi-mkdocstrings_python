...
Source0  : https://files.pythonhosted.org/packages/21/5e/1503ca2129b24e908eb075e87051e16ec583551423b8d305107e49a0bebb/mkdocstrings_python-1.8.0.tar.gz
...
%prep
%setup -q -n mkdocstrings_python-1.8.0
cd %{_builddir}/mkdocstrings_python-1.8.0
pushd ..
cp -a mkdocstrings_python-1.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704820275
